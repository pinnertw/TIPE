...
Dans un (m, n, 9)-jeu, il n'y a que trois directions pour gagner: horizontalement, verticalement et en diagonale. Dans la figure. \ref{fig:m-n-9}, on apparie les cases en liant les deux cases en gris. Par la symétrie, il suffit de regarder l'horizontale et la diagonale. On considére donc les deux lignes rouges. Les deux lignes rouges passent une ligne grise, et puisque ces lignes grises sont invariant par une translation de 8 cases dans les trois directions, toutes les lignes horizontale, verticale ou diagonale de longueur 9 passent une ligne grise. Ainsi, le deuxième joueur suffit de suivre le premier joueur en plaçant son symbole sur la case alignée à celle où le premier joueur place. Le premier joueur ne peut jamais réussir dans ce cas, et donc la stratégie gagnante n'existe pas dans le (m, n, 9)-jeu.\par
...
\begin{itemize}
    \item toute ligne horizontale de longueur 8 passe une ligne gagnante du sous-jeu (trois symboles en diagonale).
